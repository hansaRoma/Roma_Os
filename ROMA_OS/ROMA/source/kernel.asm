;ROMA --- The ROMA Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE ROMAOS_VER '1.0.0'	 ;OS version number
	%DEFINE ROMAOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as ROMAOS and its programs
...
option_screen:
	...
	mov cx, 11001111b		; Colour: white text on light red
	...
	os_init_msg		db '////////////////////Welcome to ROMA OS\\\\\\\\\\\\\\\\\\\\\\\\\\\\', 0
	os_version_msg		db 'Version ', ROMAOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', ROMAOS_VER, 0

	dialog_string_1		db 'Welcome to ROMA Operating System', 0
...
os_draw_background1:
	...
	mov cx, 01101111b		; Colour: white text on light brown
